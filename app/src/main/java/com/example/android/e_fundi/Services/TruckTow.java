...
public class TruckTow extends AppCompatActivity {
    List<items> lstItem;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trucktow);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.garage:
                    startActivity(new Intent(TruckTow.this, MapMecActivity.class));

                    return true;

                case R.id.petrolS:
                    startActivity(new Intent(TruckTow.this, PetrolStations.class));

                    return true;

                case R.id.spareS:
                    startActivity(new Intent(TruckTow.this, SpareShop.class));

                    return true;

                case R.id.feedback:
                    Intent intentMarket = new Intent(TruckTow.this, fedbackActivity.class);
...
//
    ...
    class myTaskHW extends AsyncTask<Void, List, String> {
        ...
        protected void onPreExecute() {
            ...
            mAdapter = new Recycler_Item(TruckTow.this, lstItem);
...
//                public void onResponse(String response) {
            ...
            try {
                ...
                lstItem.add(new items("12-02-2018","Tow truck vip","Ssenoga", R.drawable.towtruck));
                lstItem.add(new items("12-12-2017","tis tow truck","Ssenoga", R.drawable.towtruck1));

                publishProgress(lstItem);

            } catch (Exception e) {
                Toast.makeText(TruckTow.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        protected void onProgressUpdate(List... values) {
            ...
            RecyclerView myrx4 = (RecyclerView) findViewById(R.id.recyclerTowTruck);
            myrx4.setNestedScrollingEnabled(false);
            GridLayoutManager layoutManager4 = new GridLayoutManager(TruckTow.this, 1);
