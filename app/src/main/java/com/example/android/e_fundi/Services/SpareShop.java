...
public class SpareShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spare_shop);
    ...
    class myTaskHW extends AsyncTask<Void, List, String> {
        ...
        protected void onPreExecute() {
            ...
            mAdapter = new Recycler_Item(SpareShop.this, lstItem);
...
//                public void onResponse(String response) {
            ...
            try {
                ...
                Toast.makeText(SpareShop.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        protected void onProgressUpdate(List... values) {
            ...
            RecyclerView myrx4 = (RecyclerView) findViewById(R.id.recyclerSpearItem);
            myrx4.setNestedScrollingEnabled(false);
            GridLayoutManager layoutManager4 = new GridLayoutManager(SpareShop.this, 1);
